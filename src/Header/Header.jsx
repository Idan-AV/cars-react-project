...
let pages = ['Home','Saved Cars','My Cars'];
let settings = ['Login','Profile','Logout','signup'];
const pageMapping = {
  Home: '/',
...
function Header() {
    ...
    if(user.user!==null){
      ...
      settings=['Login','signup']
       ...
       settings = ['Login','Profile', 'Account','Logout','signup'];
          ...
          <Box sx={{ flexGrow: 0}}>
            <Tooltip title="Open settings">
              <IconButton onClick={handleOpenUserMenu} sx={{ p: 0}}>
                <Avatar alt={user.user?.username} src={user.user?.profile?.img_url} />
              </IconButton>
            </Tooltip>
            <Menu
              sx={{ mt: '45px' }}
